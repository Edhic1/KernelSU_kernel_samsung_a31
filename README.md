...
2. Go to the [Actions](https://github.com/Edhic1/KernelSU_kernel_samsung_a31/actions) tab.
...
## Credits
- [DevZillion](https://github.com/DevZillion/android_kernel_samsung_a31): Original KernelSU fork.
- [KernelSU Team](https://github.com/tiann/KernelSU): For the KernelSU project.
- [osm0sis](https://github.com/osm0sis/AnyKernel3): AnyKernel3 packaging tool.
- Samsung: For open-source kernel code.
- LineageOS: Base for the kernel configuration.

## License
This kernel is licensed under the [GPL-2.0](https://github.com/Edhic1/KernelSU_kernel_samsung_a31/blob/kernel_su/LICENSE). KernelSU modifications are under their respective licenses.
